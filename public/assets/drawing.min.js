(function() {
  jQuery(function() {
    ...
    drawHedge = function(x, y, z) {
      iso.add(Shape.Prism(new Point(x, y, z), 1, 1, 3).scale(new Point(x, y, z), 0.1, 0.1, 0.1), blue);
      iso.add(Shape.Prism(new Point(x, y + 5, z), 1, 1, 3).scale(new Point(x, y, z), 0.1, 0.1, 0.1), blue);
